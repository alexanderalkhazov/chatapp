    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageUser", x => new { x.ReadById, x.ReadMessagesId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReceivedMessagesId = table.Column<int>(type: "integer", nullable: false),
                    ReceiversId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageUser1", x => new { x.ReceivedMessagesId, x.ReceiversId });
                    table.ForeignKey(
                        name: "FK_MessageUser1_Messages_ReceivedMessagesId",
                        column: x => x.ReceivedMessagesId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageUser1_Users_ReceiversId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageUser_ReadMessagesId",
                table: "MessageUser",
                column: "ReadMessagesId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageUser1_ReceiversId",
                table: "MessageUser1",
                column: "ReceiversId");
        }
